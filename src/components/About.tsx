...
const AboutMobile = () => {
  return (
    <div
      className="bg-[#050505] relative z-10 min-h-screen flex items-center justify-center py-20 px-4"
      id="about"
    >
      {/* Ambient glow */}
      <div className="absolute inset-0 flex items-center justify-center opacity-25 pointer-events-none">
        <div className="w-[80vw] h-[80vw] bg-blue-600 rounded-full blur-[120px]" />
      </div>
      ...
      >
        <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 flex flex-col items-center shadow-2xl relative">
    ...
    const ctx = gsap.context(() => {
      ...
      HEADLINE.split(' ').forEach((word) => {
        ...
        word.split('').forEach((char) => {
          ...
          span.style.cssText =
            'display:inline-block; font-size:clamp(2.5rem,7.5vw,8rem); font-weight:900; font-family:inherit; color:#ffffff; line-height:1; text-transform:uppercase; will-change:transform,opacity;';
    ...
    <div ref={containerRef} className="bg-[#050505] relative z-10" id="about">
      ...
      >
        ...
        <div className="relative z-20 text-center max-w-2xl w-full flex flex-col items-center px-4">
          ...
          <div
            ref={statsRef}
            className="flex items-start justify-center gap-12 md:gap-20"
          >
            {STATS.map((stat, i) => (
